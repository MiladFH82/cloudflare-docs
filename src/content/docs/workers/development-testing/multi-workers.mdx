...
The same limitations for bindings apply when Workers are run across multiple dev commands, which limits to service bindings or tail consumers at the moment.
